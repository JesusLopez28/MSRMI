...
public interface ClienteServidor extends Remote{
    ...
    void enviarArray(int[] array, String tipoOrdenamiento) throws java.rmi.RemoteException;
    ...
    void recibirArrayFinal(int[] array, long tiempoEjecucion) throws java.rmi.RemoteException;
}
